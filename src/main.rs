...
fn main() -> ! {
    ...
    fn run_forward<PIN0: OutputPin, PIN1: OutputPin, PIN2: OutputPin>(servo0: &mut PIN0, servo1: &mut PIN1, servo2: &mut PIN2) {
    ...
    // Calibration mode
    loop {
        run_forward(&mut servo0, &mut servo1, &mut servo2);
    }
}